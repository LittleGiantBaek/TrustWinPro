...
public class EventFunc {
	...
	public String deviceVal(){
		Connection conn = null;
		String val = "";
		String sql = "select deviceSort from dbo.Sort where idx = 1; ";
			try {
					Context init = new InitialContext();
					DataSource ds = (DataSource)init.lookup("java:comp/env/jdbc/MssqlDB");
					conn = ds.getConnection();
	...
	public String userVal(){
		Connection conn = null;
		String val = "";
		String sql = "select userSort from dbo.Sort where idx = 1; ";
			try {
					Context init = new InitialContext();
					DataSource ds = (DataSource)init.lookup("java:comp/env/jdbc/MssqlDB");
					conn = ds.getConnection();
	...
	public String eventVal(){
		Connection conn = null;
		String val = "";
		String sql = "select eventSort from dbo.Sort where idx = 1; ";
			try {
					Context init = new InitialContext();
					DataSource ds = (DataSource)init.lookup("java:comp/env/jdbc/MssqlDB");
					conn = ds.getConnection();
