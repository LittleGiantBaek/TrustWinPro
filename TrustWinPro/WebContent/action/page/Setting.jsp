...
<section class="contents ng-scope" id="contents">
    ...
    <article class="settingMain">
        <ul>
            <li class="account" ng-privilege="SETTING" data-hide-when-not-allowed="true"><a href="#a" onclick="location.href='/TrustWinPro/action/index.jsp?content=SettingAccount'"><span ng-label="common.account">계정</span></a></li>
