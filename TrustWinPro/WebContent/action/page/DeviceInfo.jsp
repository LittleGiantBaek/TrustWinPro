...
%>
				...
				<div class="InfoButtom" id="web-buttons-idrmij3">
					<a href="#" title="Delete" onclick="Delete('S,D,D,2,1,<%=UID%>,E')"><%=lanFunc.language(lan, 88)%></a>
					<a href="#" title="Enroll" onclick="Enroll('S,D,E,2,1,<%=UID%>,E')"><%=lanFunc.language(lan, 183)%></a>
				</div>
			</div>
...
%>
				...
				<div class="InfoButtom" id="web-buttons-idrmij3">
					<a href="#" title="Delete" onclick="Delete('S,D,D,2,2,<%=UID%>,E')"><%=lanFunc.language(lan, 88)%></a>
					<a href="#" title="Enroll" onclick="Enroll('S,D,E,2,2,<%=UID%>,E')"><%=lanFunc.language(lan, 183)%></a>
				</div>
			</div>
<%
...
%>		
				...
				<div class="InfoButtom" id="web-buttons-idrmij3">
					<a href="#" title="Delete" onclick="Delete('S,D,D,2,7,<%=UID%>,E')"><%=lanFunc.language(lan, 88)%></a>
					<a href="#" title="Enroll" onclick="Enroll('S,D,E,2,7,<%=UID%>,E')"><%=lanFunc.language(lan, 183)%></a>
				</div>
			</div>
<%
	Event[] eventG = null;
