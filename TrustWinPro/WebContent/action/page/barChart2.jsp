...
<div>
	<section style = "overflow: hidden;border: 2px solid #46bebe; border-radius: 6px;-webkit-box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.15);
		...
		padding: 0;
		color: #5a5a5a;
		font: normal 12px/0.9 Roboto, 'Nanum Gothic', 'µ∏øÚ', Dotum, '±º∏≤', Gulim, sans-serif;
		...
		<div id="chart_div" >
			<dl> 
				 <dt>    √‚¿‘¿Œø¯  </dt>  
				 <dd class="percentage percentage-3"><span class="text">IE 11: 3</span></dd>  
				 <dd class="percentage percentage-6"><span class="text">Chrome: 6</span></dd>  
				 <dd class="percentage percentage-4"><span class="text">Firefox: 4</span></dd> 
				 <dd class="percentage percentage-9"><span class="text">IE 11: 9</span></dd>  
			 </dl>
		</div>
	</section>
</div>
